...
export default function DashboardPage() {
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 lg:py-12">
      ...
      <GlassCard glow className="mb-8 flex flex-col sm:flex-row items-start sm:items-center gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-slate-400 mt-1">
            Select a tool below to analyze suspicious content. Results include trust score,
            threat breakdown, and recovery steps.
          </p>
        </div>
      </GlassCard>
